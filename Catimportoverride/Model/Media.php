<?php
namespace Wiredcraft\Catimportoverride\Model;
...
class Media extends AbstractImportValidator implements RowValidatorInterface
{
    ...
    {  
        ...
        if (isset($value[self::ADDITIONAL_IMAGES]) && strlen($value[self::ADDITIONAL_IMAGES])) {
		 ...
		 $valid = true;// Custom Added to return always ture 

		 $this->logger->debug("----------- vendor/magento/module-catalog-import/model/import/product/validator/Media.php override ------------");
